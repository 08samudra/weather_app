...
import 'package:flutter_clone2/app_quiz/03-10_dbhelper.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 0, 219, 248),
        centerTitle: true,
        actions: <Widget>[
  ...
  void _showContactPage({Contact? contact, required OrderOptions order}) async {
  ...
  Future<void> _getAllContacts(OrderOptions order) async {
