...
import 'package:flutter_clone2/app_1/api_service/ambon.dart';
import 'package:flutter_clone2/app_1/api_service/weather_data.dart';
import 'package:intl/intl.dart';

class WeatherAmbon extends StatefulWidget {
  const WeatherAmbon({super.key});

  @override
  State<WeatherAmbon> createState() => _WeatherAmbonState();
}

class _WeatherAmbonState extends State<WeatherAmbon> {
  ...
  Future<void> myWeather() async {
    ...
    try {
      WeatherDataApp value = await WeatherServicesAmbon().fetchWeather();
